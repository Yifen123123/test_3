...
# Template Renderer
# ---------------------------------------------------------------------
def render_reply(payload: Dict[str, Any], doc_class: str) -> str:
    ...
    return tpl.render(
        ...
        transfer_info=payload.get("transfer_info", {}),  # 新增：支援函轉資訊
        # === 日期欄位 ===
...
def main():
    ...
    for fp in txt_files:
        ...
        reply = render_reply(payload, doc_class=doc_class)
